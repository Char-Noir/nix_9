...
@ListSubroutine
public class ReceptionFindAllSubroutine extends ConsoleResponceSubroutine {
    public final String LONG_DESCRIPTION = "Показывает все приёмы";
    public final String SHORT_DESCRIPTION = "Показать приёмы";
    public final String URL = "showall/receptions";
