...
public class ReceptionFindByPatientIdSubroutine extends ConsoleResponceSubroutine {

    public final String LONG_DESCRIPTION = "Показывает приём по Id пациента если есть";
    public final String SHORT_DESCRIPTION = "Показать приём по пациенту";
    public final String URL = "showbypatient/receptions";
    public final String EXPECTED_INPUT = "Целое число - Id пациента";
