...
public class PatientDeleteByIdSubroutine extends ConsoleResponceSubroutine {

    public final String LONG_DESCRIPTION = "Удаляет пациента по Id если есть";
    public final String SHORT_DESCRIPTION = "Удалить пациента";
    public final String URL = "delete/patients";
