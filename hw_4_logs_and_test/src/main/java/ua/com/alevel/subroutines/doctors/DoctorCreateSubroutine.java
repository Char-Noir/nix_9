...
public class DoctorCreateSubroutine extends ConsoleResponceSubroutine {

    public final String LONG_DESCRIPTION = "Создает доктора";
    public final String SHORT_DESCRIPTION = "Создать доктора";
    public final String URL = "create/doctors";
    ...
    public Responce run(BufferedReader bufferedReader) {
        try {
            ...
            Responce responce = controller.create( name, assessmentOfCertification, doctorNote, dateOfCertification, login, hashPassword, categoryS, specializationS);
