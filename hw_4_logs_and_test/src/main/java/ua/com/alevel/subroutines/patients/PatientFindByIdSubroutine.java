...
public class PatientFindByIdSubroutine extends ConsoleResponceSubroutine {

    public final String LONG_DESCRIPTION = "Показывает пациента по Id если есть";
    public final String SHORT_DESCRIPTION = "Показать пациента";
    public final String URL = "showbyid/patients";
