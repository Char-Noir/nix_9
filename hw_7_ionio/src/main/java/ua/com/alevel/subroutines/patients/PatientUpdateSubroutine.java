...
public class PatientUpdateSubroutine extends ConsoleResponceSubroutine {

    public final String LONG_DESCRIPTION = "Обновляет пациента по Id если есть";
    public final String SHORT_DESCRIPTION = "Обновить пациента";
    public final String URL = "update/patients";
    ...
    public Responce run(BufferedReader bufferedReader) {
        try {
            ...
            Responce responce = controller.update(id, name, dateOfBirth, phoneNumber, userDocuments, login, hashPassword);
