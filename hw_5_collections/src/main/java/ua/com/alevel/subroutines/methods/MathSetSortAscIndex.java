...
public class MathSetSortAscIndex extends ua.com.alevel.console.ConsoleSubroutine {
    public final String LONG_DESCRIPTION = "Сортирует вверх множество по индексу начала и конца";
    public final String SHORT_DESCRIPTION = "Восходящая сортировка по индексам";
    ...
    public void run(BufferedReader bufferedReader) {
        ...
        try{
            ...
            MathSetUsabilityMain.mathSet.sortAsc(start,end);
