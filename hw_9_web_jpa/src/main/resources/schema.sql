...
CREATE TABLE `patient` (
                           ...
                           `patient_float` float NOT NULL DEFAULT '0',
                           `login` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
                           `hash_password` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
                           `id_status` int unsigned NOT NULL,
                           `id` bigint NOT NULL,
                           ...
                           `userDocuments` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `reception` (
                             ...
                             `receptionPrice` double DEFAULT NULL,
...
-- Dump completed on 2022-01-25 20:41:47
