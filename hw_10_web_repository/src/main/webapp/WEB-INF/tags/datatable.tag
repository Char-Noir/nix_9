<jsp:useBean id="pageData" scope="request"
             type="ua.com.alevel.hw_10_web_repository.view.PageData<ua.com.alevel.hw_10_web_repository.dto.impl.patient.PatientResponseDto>"/>
<jsp:useBean id="headerDataList" scope="request"
             type="java.util.List<ua.com.alevel.hw_10_web_repository.controller.AbstractController.HeaderData>"/>
