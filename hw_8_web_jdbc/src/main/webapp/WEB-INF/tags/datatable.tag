<jsp:useBean id="pageData" scope="request"
             type="ua.com.alevel.hw_8_web_jdbc.view.PageData<ua.com.alevel.hw_8_web_jdbc.dto.impl.patient.PatientResponseDto>"/>
<jsp:useBean id="headerDataList" scope="request"
             type="java.util.List<ua.com.alevel.hw_8_web_jdbc.controller.AbstractController.HeaderData>"/>
