...
public class DateAddTime extends ConsoleSubroutine {

    public final String LONG_DESCRIPTION = "Позволяет прибавить к дате указанную единицу времени";
    public final String SHORT_DESCRIPTION = "Прибавить";
